...
\todo{Example of a game? Prisoner's Dilemma...\newline Talk about Nash}
...
some probability. This probability may be zero for some strategies. So, if a
player plays rock with some probability and scissors with some probability, but
never paper, they are implementing a mixed strategy.
...
their opponent goes well), but it may also assign negative weight - so, our
player is "envious" when their opponent does well.
