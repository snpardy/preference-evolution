...
\end{enumerate} 
\np
So, if a mutation occurs at the point (2, 2), given that this mutation has a relatively small radius, the expected payoff of the mutation will not change because the none of the payoff points of the game being played are effected.
